...
public class SuitekiListButton extends AppCompatButton {

    public SuitekiListButton(@NonNull Context context) {
        super(context);
    }

    public SuitekiListButton(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public SuitekiListButton(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context);
    }
