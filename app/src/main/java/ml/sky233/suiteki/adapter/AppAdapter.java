...
public class AppAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemClickListener, OnItemLongClickListener, OnItemTouchListener {
    public Context mContext;

    private ArrayList<AppObject> mPublicArray;

    public AppAdapter(Context context, ArrayList<AppObject> publicArray) {
        mContext = context;
