...
public class AppBlueAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemClickListener, OnItemLongClickListener, OnItemTouchListener {
    public Context mContext;

    private ArrayList<AppObject> mPublicArray;

    public AppBlueAdapter(Context context, ArrayList<AppObject> publicArray) {
        mContext = context;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder vh, final int position) {
        ...
        holder.iv_img.setImageResource(mPublicArray.get(position).icon);
