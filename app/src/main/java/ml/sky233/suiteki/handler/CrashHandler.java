package ml.sky233.suiteki.handler;

import static ml.sky233.suiteki.MainApplication.context;
...
public class CrashHandler implements UncaughtExceptionHandler {
     ...
     * 文件名
     */
    public static final String FILE_NAME = "crashLog";
    /**
     * 异常日志 存储位置为根目录下的 Crash文件夹
     */
    private static final String PATH = context.getExternalFilesDir("").getPath() +
            "/Crash/";
    /**
     * 文件名后缀
     */
